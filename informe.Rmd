...
```{r diasdelasemana1, fig.cap="Días de la semana", message=FALSE, echo = FALSE, warning = FALSE}
...
barplot(freq, names.arg = c(
  ...
  cex.names = 0.8,
  col = "#B0F180",
  xlab = "Día de la semana", ylab = "Frecuencia absoluta", main = "Viajes por día")
```
...
```{r diasdelasemana2, fig.cap="Tabla días de la semana", message=FALSE, echo = FALSE, warning = FALSE}
...
row.names(freqTable) <- c(
  ...
  "Sabado",
  "Domingo")
knitr::kable(freqTable, caption="Frecuencias Genero por Edad")
```
...
```{r generoedad1, fig.cap="Genero por Edad", fig.height = 6, message=FALSE, echo = FALSE, warning = FALSE}
