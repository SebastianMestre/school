...
```{r generousuarios2, fig.cap="Distribución de recorridos por Genero", message=FALSE, echo = FALSE, warning = FALSE, out.width="90%"}
...
- de entre los recorridos relizados por usuarios que eligen revelar su genero, la mayoría los realizan mujeres\
Limitandonos a los usuarios que eligen revelar su genero, se ve que estos datos tienen
una relación directa, e inferimos que la razón por la que más recorridos los realizan
personas de género femenino es que estas son la mayoría.
...
La distribución muestra que el día en que se realizan más recorridos es el lunes,
mientras que los días con menor frecuencia son viernes y domingo. La disminución
de recorridos en los 2 días recién mencionados puede atribuirse a que las personas
tiendan a quedarse en sus hogares a descansar durante el fin de semana, o que
realizen actividades fuera de la casa, pero se transporten de otra manera.
